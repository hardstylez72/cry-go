...
import (
	...
	requests "github.com/hardstylez72/cry/internal/exchange/okex/driver/requests/rest/account"
	responses "github.com/hardstylez72/cry/internal/exchange/okex/driver/responses/account"
)
...
func (c *Account) GetBalance(ctx context.Context, req requests.GetBalance) (response responses.GetBalance, err error) {
