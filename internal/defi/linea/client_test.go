...
func Test(t *testing.T) {
	...
	//b, err := r.defi.Cli.NetworkID(context.TODO())
	//assert.NoError(t, err)
	//assert.NotNil(t, b)
	//b, errr := r.GetBalance(context.Background(), &defi.GetBalanceReq{
	//	WalletAddress: tests.GetConfig().Wallet.String(),
	//	Token:         v1.Token_USDC,
	//})
	...
	//exchangeRate := 1.0
	//res, err := r.Swap(context.Background(), &defi.DefaultSwapReq{
