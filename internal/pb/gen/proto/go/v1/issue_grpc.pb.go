...
const (
	IssueService_Issues_FullMethodName            = "/issue.IssueService/Issues"
	IssueService_IssuesUser_FullMethodName        = "/issue.IssueService/IssuesUser"
	IssueService_CreateIssue_FullMethodName       = "/issue.IssueService/CreateIssue"
	IssueService_DeleteIssue_FullMethodName       = "/issue.IssueService/DeleteIssue"
	IssueService_Issue_FullMethodName             = "/issue.IssueService/Issue"
	IssueService_IssueUpdateStatus_FullMethodName = "/issue.IssueService/IssueUpdateStatus"
	IssueService_AddComment_FullMethodName        = "/issue.IssueService/AddComment"
	IssueService_DeleteComment_FullMethodName     = "/issue.IssueService/DeleteComment"
)
...
func (c *issueServiceClient) Issues(ctx context.Context, in *IssuesReq, opts ...grpc.CallOption) (*IssuesRes, error) {
	out := new(IssuesRes)
	err := c.cc.Invoke(ctx, IssueService_Issues_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) IssuesUser(ctx context.Context, in *IssuesReq, opts ...grpc.CallOption) (*IssuesRes, error) {
	out := new(IssuesRes)
	err := c.cc.Invoke(ctx, IssueService_IssuesUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) DeleteIssue(ctx context.Context, in *DeleteIssueReq, opts ...grpc.CallOption) (*DeleteIssueRes, error) {
	...
	err := c.cc.Invoke(ctx, IssueService_DeleteIssue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) Issue(ctx context.Context, in *IssueReq, opts ...grpc.CallOption) (*IssueRes, error) {
	out := new(IssueRes)
	err := c.cc.Invoke(ctx, IssueService_Issue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) IssueUpdateStatus(ctx context.Context, in *IssueUpdateStatusReq, opts ...grpc.CallOption) (*IssueUpdateStatusRes, error) {
	...
	err := c.cc.Invoke(ctx, IssueService_IssueUpdateStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) AddComment(ctx context.Context, in *AddCommentReq, opts ...grpc.CallOption) (*AddCommentRes, error) {
	...
	err := c.cc.Invoke(ctx, IssueService_AddComment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) DeleteComment(ctx context.Context, in *DeleteCommentReq, opts ...grpc.CallOption) (*DeleteCommentRes, error) {
	...
	err := c.cc.Invoke(ctx, IssueService_DeleteComment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IssueService_Issues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IssueService_Issues_FullMethodName,
	}
...
func _IssueService_IssuesUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IssueService_IssuesUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _IssueService_Issue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IssueService_Issue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _IssueService_IssueUpdateStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IssueService_IssueUpdateStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _IssueService_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IssueService_DeleteComment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
