...
const (
	SettingsService_ResetSettings_FullMethodName  = "/settings.SettingsService/ResetSettings"
...
func (c *settingsServiceClient) ResetSettings(ctx context.Context, in *ResetRequest, opts ...grpc.CallOption) (*ResetResponse, error) {
	...
	err := c.cc.Invoke(ctx, SettingsService_ResetSettings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
