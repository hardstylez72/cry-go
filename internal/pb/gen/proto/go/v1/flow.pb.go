...
var file_v1_flow_proto_rawDesc = []byte{
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xa7, 0x15, 0x0a,
...
var file_v1_flow_proto_depIdxs = []int32{
	...
	17, // 48: flow.CreateFlowRequest.tasks:type_name -> flow.Task
	15, // 49: flow.UpdateFlowRequest.flow:type_name -> flow.Flow
	15, // 50: flow.UpdateFlowResponse.flow:type_name -> flow.Flow
	15, // 51: flow.CreateFlowResponse.flow:type_name -> flow.Flow
	15, // 52: flow.ListFlowResponse.flows:type_name -> flow.Flow
	19, // 53: flow.FlowService.UpdateFlow:input_type -> flow.UpdateFlowRequest
	18, // 54: flow.FlowService.CreateFlow:input_type -> flow.CreateFlowRequest
	13, // 55: flow.FlowService.GetFlow:input_type -> flow.GetFlowRequest
	22, // 56: flow.FlowService.ListFlow:input_type -> flow.ListFlowRequest
	24, // 57: flow.FlowService.DeleteFlow:input_type -> flow.DeleteFlowRequest
	11, // 58: flow.FlowService.CopyFlow:input_type -> flow.CopyFlowReq
	7,  // 59: flow.FlowService.ShareFlow:input_type -> flow.ShareFlowReq
	9,  // 60: flow.FlowService.HideFlow:input_type -> flow.HideFlowReq
	5,  // 61: flow.FlowService.SharedFlows:input_type -> flow.SharedFlowsReq
	4,  // 62: flow.FlowService.SharedFlow:input_type -> flow.SharedFlowReq
	1,  // 63: flow.FlowService.UseSharedFlow:input_type -> flow.UseSharedFlowReq
	20, // 64: flow.FlowService.UpdateFlow:output_type -> flow.UpdateFlowResponse
	21, // 65: flow.FlowService.CreateFlow:output_type -> flow.CreateFlowResponse
	14, // 66: flow.FlowService.GetFlow:output_type -> flow.GetFlowResponse
	23, // 67: flow.FlowService.ListFlow:output_type -> flow.ListFlowResponse
	25, // 68: flow.FlowService.DeleteFlow:output_type -> flow.DeleteFlowResponse
	12, // 69: flow.FlowService.CopyFlow:output_type -> flow.CopyFlowRes
	8,  // 70: flow.FlowService.ShareFlow:output_type -> flow.ShareFlowRes
	10, // 71: flow.FlowService.HideFlow:output_type -> flow.HideFlowRes
	6,  // 72: flow.FlowService.SharedFlows:output_type -> flow.SharedFlowsRes
	3,  // 73: flow.FlowService.SharedFlow:output_type -> flow.SharedFlowRes
	2,  // 74: flow.FlowService.UseSharedFlow:output_type -> flow.UseSharedFlowRes
