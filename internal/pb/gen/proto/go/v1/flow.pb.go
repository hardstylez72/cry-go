...
var file_v1_flow_proto_rawDesc = []byte{
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x87, 0x18, 0x0a,
	...
	,
...
var file_v1_flow_proto_depIdxs = []int32{
	...
	37, // 51: flow.Task.woofiSwapTask:type_name -> task.DefaultSwap
	42, // 52: flow.Task.aaveLPTask:type_name -> task.DefaultLP
	46, // 53: flow.Task.mintFunTask:type_name -> task.SimpleTask
	17, // 54: flow.CreateFlowRequest.tasks:type_name -> flow.Task
	15, // 55: flow.UpdateFlowRequest.flow:type_name -> flow.Flow
	15, // 56: flow.UpdateFlowResponse.flow:type_name -> flow.Flow
	15, // 57: flow.CreateFlowResponse.flow:type_name -> flow.Flow
	15, // 58: flow.ListFlowResponse.flows:type_name -> flow.Flow
	19, // 59: flow.FlowService.UpdateFlow:input_type -> flow.UpdateFlowRequest
	18, // 60: flow.FlowService.CreateFlow:input_type -> flow.CreateFlowRequest
	13, // 61: flow.FlowService.GetFlow:input_type -> flow.GetFlowRequest
	22, // 62: flow.FlowService.ListFlow:input_type -> flow.ListFlowRequest
	24, // 63: flow.FlowService.DeleteFlow:input_type -> flow.DeleteFlowRequest
	11, // 64: flow.FlowService.CopyFlow:input_type -> flow.CopyFlowReq
	7,  // 65: flow.FlowService.ShareFlow:input_type -> flow.ShareFlowReq
	9,  // 66: flow.FlowService.HideFlow:input_type -> flow.HideFlowReq
	5,  // 67: flow.FlowService.SharedFlows:input_type -> flow.SharedFlowsReq
	4,  // 68: flow.FlowService.SharedFlow:input_type -> flow.SharedFlowReq
	1,  // 69: flow.FlowService.UseSharedFlow:input_type -> flow.UseSharedFlowReq
	20, // 70: flow.FlowService.UpdateFlow:output_type -> flow.UpdateFlowResponse
	21, // 71: flow.FlowService.CreateFlow:output_type -> flow.CreateFlowResponse
	14, // 72: flow.FlowService.GetFlow:output_type -> flow.GetFlowResponse
	23, // 73: flow.FlowService.ListFlow:output_type -> flow.ListFlowResponse
	25, // 74: flow.FlowService.DeleteFlow:output_type -> flow.DeleteFlowResponse
	12, // 75: flow.FlowService.CopyFlow:output_type -> flow.CopyFlowRes
	8,  // 76: flow.FlowService.ShareFlow:output_type -> flow.ShareFlowRes
	10, // 77: flow.FlowService.HideFlow:output_type -> flow.HideFlowRes
	6,  // 78: flow.FlowService.SharedFlows:output_type -> flow.SharedFlowsRes
	3,  // 79: flow.FlowService.SharedFlow:output_type -> flow.SharedFlowRes
	2,  // 80: flow.FlowService.UseSharedFlow:output_type -> flow.UseSharedFlowRes
