...
var file_v1_flow_proto_rawDesc = []byte{
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xac, 0x16, 0x0a,
	...
	0x67, 0x65, 0x53, 0x77, 0x61, 0x70, 0x54, 0x61, 0x73, 0x6b, 0x3a, 0x27, 0x92, 0x41, 0x24, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x22, 0x62, 0x0a, 0x11, 0x43,
	...
	0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x20, 0x0a, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x54, 0x61, 0x73,
	0x6b, 0x52, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x3a, 0x15, 0x92, 0x41, 0x12, 0x0a, 0x10, 0xd2,
	0x01, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0xd2, 0x01, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x22,
...
var file_v1_flow_proto_depIdxs = []int32{
	...
	17, // 50: flow.CreateFlowRequest.tasks:type_name -> flow.Task
	15, // 51: flow.UpdateFlowRequest.flow:type_name -> flow.Flow
	15, // 52: flow.UpdateFlowResponse.flow:type_name -> flow.Flow
	15, // 53: flow.CreateFlowResponse.flow:type_name -> flow.Flow
	15, // 54: flow.ListFlowResponse.flows:type_name -> flow.Flow
	19, // 55: flow.FlowService.UpdateFlow:input_type -> flow.UpdateFlowRequest
	18, // 56: flow.FlowService.CreateFlow:input_type -> flow.CreateFlowRequest
	13, // 57: flow.FlowService.GetFlow:input_type -> flow.GetFlowRequest
	22, // 58: flow.FlowService.ListFlow:input_type -> flow.ListFlowRequest
	24, // 59: flow.FlowService.DeleteFlow:input_type -> flow.DeleteFlowRequest
	11, // 60: flow.FlowService.CopyFlow:input_type -> flow.CopyFlowReq
	7,  // 61: flow.FlowService.ShareFlow:input_type -> flow.ShareFlowReq
	9,  // 62: flow.FlowService.HideFlow:input_type -> flow.HideFlowReq
	5,  // 63: flow.FlowService.SharedFlows:input_type -> flow.SharedFlowsReq
	4,  // 64: flow.FlowService.SharedFlow:input_type -> flow.SharedFlowReq
	1,  // 65: flow.FlowService.UseSharedFlow:input_type -> flow.UseSharedFlowReq
	20, // 66: flow.FlowService.UpdateFlow:output_type -> flow.UpdateFlowResponse
	21, // 67: flow.FlowService.CreateFlow:output_type -> flow.CreateFlowResponse
	14, // 68: flow.FlowService.GetFlow:output_type -> flow.GetFlowResponse
	23, // 69: flow.FlowService.ListFlow:output_type -> flow.ListFlowResponse
	25, // 70: flow.FlowService.DeleteFlow:output_type -> flow.DeleteFlowResponse
	12, // 71: flow.FlowService.CopyFlow:output_type -> flow.CopyFlowRes
	8,  // 72: flow.FlowService.ShareFlow:output_type -> flow.ShareFlowRes
	10, // 73: flow.FlowService.HideFlow:output_type -> flow.HideFlowRes
	6,  // 74: flow.FlowService.SharedFlows:output_type -> flow.SharedFlowsRes
	3,  // 75: flow.FlowService.SharedFlow:output_type -> flow.SharedFlowRes
	2,  // 76: flow.FlowService.UseSharedFlow:output_type -> flow.UseSharedFlowRes
