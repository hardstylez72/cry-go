...
var file_v1_flow_proto_rawDesc = []byte{
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xee, 0x14, 0x0a,
	...
	0x73, 0x73, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x3a, 0x27, 0x92, 0x41,
	...
	0x6c, 0x6f, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x92, 0x08, 0x0a, 0x0b,
...
var file_v1_flow_proto_depIdxs = []int32{
	...
	17, // 47: flow.CreateFlowRequest.tasks:type_name -> flow.Task
	15, // 48: flow.UpdateFlowRequest.flow:type_name -> flow.Flow
	15, // 49: flow.UpdateFlowResponse.flow:type_name -> flow.Flow
	15, // 50: flow.CreateFlowResponse.flow:type_name -> flow.Flow
	15, // 51: flow.ListFlowResponse.flows:type_name -> flow.Flow
	19, // 52: flow.FlowService.UpdateFlow:input_type -> flow.UpdateFlowRequest
	18, // 53: flow.FlowService.CreateFlow:input_type -> flow.CreateFlowRequest
	13, // 54: flow.FlowService.GetFlow:input_type -> flow.GetFlowRequest
	22, // 55: flow.FlowService.ListFlow:input_type -> flow.ListFlowRequest
	24, // 56: flow.FlowService.DeleteFlow:input_type -> flow.DeleteFlowRequest
	11, // 57: flow.FlowService.CopyFlow:input_type -> flow.CopyFlowReq
	7,  // 58: flow.FlowService.ShareFlow:input_type -> flow.ShareFlowReq
	9,  // 59: flow.FlowService.HideFlow:input_type -> flow.HideFlowReq
	5,  // 60: flow.FlowService.SharedFlows:input_type -> flow.SharedFlowsReq
	4,  // 61: flow.FlowService.SharedFlow:input_type -> flow.SharedFlowReq
	1,  // 62: flow.FlowService.UseSharedFlow:input_type -> flow.UseSharedFlowReq
	20, // 63: flow.FlowService.UpdateFlow:output_type -> flow.UpdateFlowResponse
	21, // 64: flow.FlowService.CreateFlow:output_type -> flow.CreateFlowResponse
	14, // 65: flow.FlowService.GetFlow:output_type -> flow.GetFlowResponse
	23, // 66: flow.FlowService.ListFlow:output_type -> flow.ListFlowResponse
	25, // 67: flow.FlowService.DeleteFlow:output_type -> flow.DeleteFlowResponse
	12, // 68: flow.FlowService.CopyFlow:output_type -> flow.CopyFlowRes
	8,  // 69: flow.FlowService.ShareFlow:output_type -> flow.ShareFlowRes
	10, // 70: flow.FlowService.HideFlow:output_type -> flow.HideFlowRes
	6,  // 71: flow.FlowService.SharedFlows:output_type -> flow.SharedFlowsRes
	3,  // 72: flow.FlowService.SharedFlow:output_type -> flow.SharedFlowRes
	2,  // 73: flow.FlowService.UseSharedFlow:output_type -> flow.UseSharedFlowRes
