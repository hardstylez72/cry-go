...
var file_v1_flow_proto_rawDesc = []byte{
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xc3, 0x18, 0x0a,
	...
	0x6e, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x3a, 0x0a, 0x0e, 0x6d, 0x69, 0x6e, 0x74, 0x4d, 0x65, 0x72,
	0x6b, 0x6c, 0x79, 0x54, 0x61, 0x73, 0x6b, 0x18, 0x30, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e,
	0x74, 0x61, 0x73, 0x6b, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x48,
	0x00, 0x52, 0x0e, 0x6d, 0x69, 0x6e, 0x74, 0x4d, 0x65, 0x72, 0x6b, 0x6c, 0x79, 0x54, 0x61, 0x73,
...
var file_v1_flow_proto_depIdxs = []int32{
	...
	46, // 54: flow.Task.mintMerklyTask:type_name -> task.SimpleTask
	17, // 55: flow.CreateFlowRequest.tasks:type_name -> flow.Task
	15, // 56: flow.UpdateFlowRequest.flow:type_name -> flow.Flow
	15, // 57: flow.UpdateFlowResponse.flow:type_name -> flow.Flow
	15, // 58: flow.CreateFlowResponse.flow:type_name -> flow.Flow
	15, // 59: flow.ListFlowResponse.flows:type_name -> flow.Flow
	19, // 60: flow.FlowService.UpdateFlow:input_type -> flow.UpdateFlowRequest
	18, // 61: flow.FlowService.CreateFlow:input_type -> flow.CreateFlowRequest
	13, // 62: flow.FlowService.GetFlow:input_type -> flow.GetFlowRequest
	22, // 63: flow.FlowService.ListFlow:input_type -> flow.ListFlowRequest
	24, // 64: flow.FlowService.DeleteFlow:input_type -> flow.DeleteFlowRequest
	11, // 65: flow.FlowService.CopyFlow:input_type -> flow.CopyFlowReq
	7,  // 66: flow.FlowService.ShareFlow:input_type -> flow.ShareFlowReq
	9,  // 67: flow.FlowService.HideFlow:input_type -> flow.HideFlowReq
	5,  // 68: flow.FlowService.SharedFlows:input_type -> flow.SharedFlowsReq
	4,  // 69: flow.FlowService.SharedFlow:input_type -> flow.SharedFlowReq
	1,  // 70: flow.FlowService.UseSharedFlow:input_type -> flow.UseSharedFlowReq
	20, // 71: flow.FlowService.UpdateFlow:output_type -> flow.UpdateFlowResponse
	21, // 72: flow.FlowService.CreateFlow:output_type -> flow.CreateFlowResponse
	14, // 73: flow.FlowService.GetFlow:output_type -> flow.GetFlowResponse
	23, // 74: flow.FlowService.ListFlow:output_type -> flow.ListFlowResponse
	25, // 75: flow.FlowService.DeleteFlow:output_type -> flow.DeleteFlowResponse
	12, // 76: flow.FlowService.CopyFlow:output_type -> flow.CopyFlowRes
	8,  // 77: flow.FlowService.ShareFlow:output_type -> flow.ShareFlowRes
	10, // 78: flow.FlowService.HideFlow:output_type -> flow.HideFlowRes
	6,  // 79: flow.FlowService.SharedFlows:output_type -> flow.SharedFlowsRes
	3,  // 80: flow.FlowService.SharedFlow:output_type -> flow.SharedFlowRes
	2,  // 81: flow.FlowService.UseSharedFlow:output_type -> flow.UseSharedFlowRes
