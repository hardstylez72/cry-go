...
func (x *Task) GetZkLandLPTask() *DefaultLP {
	if x, ok := x.GetTask().(*Task_ZkLandLPTask); ok {
		return x.ZkLandLPTask
	}
	return nil
}
...
type Task_ZkLandLPTask struct {
	ZkLandLPTask *DefaultLP `protobuf:"bytes,44,opt,name=zkLandLPTask,proto3,oneof"`
}
...
func (*Task_ZkLandLPTask) isTask_Task() {}
...
var file_v1_flow_proto_rawDesc = []byte{
	...
	0x4c, 0x61, 0x6e, 0x64, 0x4c, 0x50, 0x54, 0x61, 0x73, 0x6b, 0x18, 0x2c, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x4c,
	0x50, 0x48, 0x00, 0x52, 0x0c, 0x7a, 0x6b, 0x4c, 0x61, 0x6e, 0x64, 0x4c, 0x50, 0x54, 0x61, 0x73,
...
var file_v1_flow_proto_depIdxs = []int32{
	...
	42, // 50: flow.Task.zkLandLPTask:type_name -> task.DefaultLP
