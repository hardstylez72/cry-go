...
const (
	StatService_ZkSyncStat_FullMethodName = "/stat.StatService/ZkSyncStat"
)
...
func (c *statServiceClient) ZkSyncStat(ctx context.Context, in *ZkSyncStatReq, opts ...grpc.CallOption) (*ZkSyncStatRes, error) {
	...
	err := c.cc.Invoke(ctx, StatService_ZkSyncStat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatService_ZkSyncStat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatService_ZkSyncStat_FullMethodName,
	}
