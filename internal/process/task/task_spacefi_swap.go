...
func SpaceFiSwap(ctx context.Context, profile *halp.Profile, p *v1.SpaceFiSwapTask, client zksyncera.SpaceFiSwapper, estimation *v1.EstimationTx) (*defi.DefaultRes, *bozdo.Gas, error) {
