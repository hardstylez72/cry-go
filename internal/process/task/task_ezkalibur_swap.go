...
func EzkaliburSwap(ctx context.Context, profile *halp.Profile, p *v1.EzkaliburSwapTask, client zksyncera.EzkaliburSwapper, estimation *v1.EstimationTx) (*defi.DefaultRes, *defi.Gas, error) {
	...
	res, err := client.EzkaliburSwap(ctx, &defi.DefaultSwapReq{
		...
		Gas:          Gas,
		Debug:        false,
		Slippage:     getSlippage(s.Source, v1.TaskType_EzkaliburSwap),
	})
	if err != nil {
		return nil, nil, err
	}
