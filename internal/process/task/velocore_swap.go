...
func VelocoreSwap(ctx context.Context, profile *halp.Profile, p *v1.VelocoreSwapTask, client zksyncera.VelocoreSwapper, estimation *v1.EstimationTx) (*bozdo.DefaultRes, *bozdo.Gas, error) {
	...
	res, err := client.VelocoreSwap(ctx, &defi.DefaultSwapReq{
		...
		Gas:          Gas,
		Debug:        false,
		Slippage:     getSlippage(s.Source, v1.TaskType_VelocoreSwap),
	})
	if err != nil {
		return nil, nil, err
	}
