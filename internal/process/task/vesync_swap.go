...
func (t *VeSyncSwapTask) Type() v1.TaskType {
	return v1.TaskType_VeSyncSwap
}
...
func VeSyncSwap(ctx context.Context, profile *halp.Profile, p *v1.VeSyncSwapTask, client zksyncera.VeSyncSwapper, estimation *v1.EstimationTx) (*bozdo.DefaultRes, *bozdo.Gas, error) {
	...
	res, err := client.VeSyncSwap(ctx, &defi.DefaultSwapReq{
		...
		Gas:          Gas,
		Debug:        false,
		Slippage:     getSlippage(s.Source, v1.TaskType_VeSyncSwap),
	})
	if err != nil {
		return nil, nil, err
	}
