...
import {NFTMintFunSpec} from "@/components/tasks/NFT/NFTMintFun";
import {NFTMerklyMintSpec, NFTMerklySpec} from "@/components/tasks/NFT/NFTMerkly";
import {NFTZeriusMintSpec} from "@/components/tasks/NFT/NFTZeruis";
...
import {StarknetIdMintSpec} from "@/components/tasks/OTHER/StarknetId";
